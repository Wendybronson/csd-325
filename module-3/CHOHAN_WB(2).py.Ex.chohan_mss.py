"""
Name: Wendy Bronson
CSD325-300H Advanced Python
Module 3.2 Assignment part 2
Date: 06/20/2026
...
Modifications:
1. Changed input prompt to initials (wb:)
2. Changed house fee from 10% to 12%
3. Added bonus notice to introduction
4. Added 10 mon bonus for dice totals of 2 or 7
Cho-Han, by Al Sweigart al@inventwithpython.com
The traditional Japanese dice game of even-odd.
View this code athttps://nostarch.com/big-book-small-python-projects
Tags: short, beginner, game
...
BONUS: If the diect total equals 2 or 7, you receive a 10 mon bonus!
''')
